#imports code from the fresh_tomatoes file to store appropriately in the website
import fresh_tomatoes
#imports code from the trailers file which will organizes the code based on arrary parameters specified in trailers.py
import trailers

#arrays storing the info to be viewed on the site
star_wars = trailers.Movie("Star Wars: The Force Awakens",
                           "Three decades after the defeat of the Galactic Empire,\ a new threat arises. The First Order attempts to rule the galaxy \ and only a ragtag group of heroes can stop them, \ along with the help of the Resistance.",
                           "http://vignette2.wikia.nocookie.net/starwars/images/f/fd/Star_Wars_Episode_VII_The_Force_Awakens.jpg/revision/latest?cb=20151018162823", #noqa
...
chef = trailers.Movie("Chef",
                      ...
                      "https://upload.wikimedia.org/wikipedia/en/b/b8/Chef_2014.jpg", # noqa
...
#I know its dated, but I love this movie
star_trek = trailers.Movie("Star Trek: First Contact",
                           ...
                           "https://upload.wikimedia.org/wikipedia/en/d/dd/Star_Trek_08-poster.png", # noqa
